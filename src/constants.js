...
export const RIGHT_MONITORING_DUPLICATE = 128005;
export const RIGHT_MONITORING_RECALCULATE = 128006;

export const RIGHT_MONITORING_ADD_VALUE = 128007;
export const RIGHT_MONITORING_EDIT_VALUE = 128008;
export const RIGHT_MONITORING_DELETE_VALUE = 128009;
export const RIGHT_MONITORING_VALIDATE_VALUE = 128010;
